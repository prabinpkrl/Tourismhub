  ...
  const planningSteps = [
    {
      ...
      description:
        "Select from our featured destinations based on your interests and travel style",
      icon: MapPin,
      color: "bg-blue-500",
    },
    {
      ...
      description:
        "Decide on activities, duration, and create a day-by-day travel plan",
      icon: Calendar,
      color: "bg-green-500",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-orange-100 mb-8 max-w-3xl mx-auto">
              Everything you need to know for an amazing journey - from planning
              to packing
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-600">
              Follow these steps for a smooth travel experience
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-600">
              Important information for your trip preparation
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-600">
              Estimate your travel costs based on your style
            </p>
          </motion.div>
            ...
            {budgetGuide.map((budget, index) => (
              <motion.div
                ...
                className={`rounded-2xl p-6 ${
                  index === 1 ? "bg-orange-500 text-white" : "bg-slate-50"
              ...
              >
                ...
                <div
                  className={`text-3xl font-bold mb-4 ${
                    index === 1 ? "text-white" : "text-orange-600"
                  }`}
                >
                  {budget.dailyBudget}
                  ...
                  <div>
                    <h4
                      className={`font-semibold mb-1 ${
                        index === 1 ? "text-orange-100" : "text-slate-700"
                      }`}
                    >
                      Accommodation
                    </h4>
                    <p
                      className={`text-sm ${
                        index === 1 ? "text-orange-100" : "text-slate-600"
                      }`}
                    >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-600">
              Don't forget these important items for your journey
            </p>
          </motion.div>
